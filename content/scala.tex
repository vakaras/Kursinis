...
Remiantis \ref{chapter:component} skyriuje pateiktu komponentinio
modelio apibrėžimu, galima pabandyti nusakyti \plangname{Scala}
komponentinį modelį:
\begin{enumerate}
  ...
  \item komponentų sąveika:
    \begin{enumerate}
      \item kadangi komponentų egzemplioriai \en{component instances}
...
% A component model defines a set of standards for component
% implementation, naming, interoperability, customization, composition,
% evolution and deployment.

\plangname{Scala} komponentai yra 
