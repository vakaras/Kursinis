...
Programavimas komponentiškai su \plangname{Scala} remiasi Torto
dizaino šablonu \en{Cake design pattern}, kuris pirmą kartą buvo
aprašytas \cite{scalable-component-abstractions}. (Pavadinimas buvo
sugalvotas vėliau.) Plačiau aprašyta čia:
\cite{wampler2009programming}.
