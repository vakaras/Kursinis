...
komponentai. Taigi galima būtų teigti, kad \plangname{Scala}
komponentinis modelis šios komponento apibrėžimo dalies netenkina.
...
properties}\NFIXME{Vadovo pastaba: „būtų gerai pasakyti, kas tai
yra (ar pavyzdį duoti).“}:
\begin{enumerate}
...
\TODO{Scala palaiko recursive dependencies su statiniu patikrinimu. Ar
kiti komponentiniai modeliai tai palaiko?}
