...
that can be composed into a functioning system. To enable composition,
a software component adheres to a particular component model and
...
\section{Apibrėžimų tipai}

\begin{itemize}
  Akcentuoja komponentinį modelį:
  \item \cite{heineman2001component}
    \begin{itemize}
      \item \cite{analytical-study-cbse};
      \item \cite{classification-framework-for-scm};
    \end{itemize}
  Nurodo, kad neturi būsenos:
  \item \cite{cs-beyond-object-oriented-programming};
  \item \cite{Sparling:2000:LLT:352183.352202};

  Kiti apibrėžimai:
  \item \cite[143]{UML-superstructure}, \cite[146]{UML-superstructure};

  Komponentas, kaip paketas:
  \item \cite[1]{Hopkins:2000:CP:352183.352198} – išvestinis apibrėžimas
    iš \cite{cs-beyond-object-oriented-programming} ir
    \cite[385]{objects-components-and-frameworks-with-uml};
  \item \cite[385]{objects-components-and-frameworks-with-uml} – atskiras
    apibrėžimas kodo komponentui
    \cite[386]{objects-components-and-frameworks-with-uml};
  \item \cite[2]{Gill:2003:CMF:966221.966237} – apibrėžimas yra išvada
    kitų autorių apibrėžimų analizės.

  Nurodo savybes:
  \item \cite[1]{scalable-component-abstractions};
\end{itemize}
