...
\TODO{Tikslas:
1.  Pasakyti, kad komponentai gali būti realizuojami ne būtinai
    objektinėmis programavimo kalbomis.
2.  Parodyti, kad komponentinės sistemos yra susijusios su SOLID.
3.  Pasakyti, kad programuojant su projektavimo schemomis
    \en{design patterns} gauname SOLID ir tuo pačiu gauname
    sistemą, kurią galima lengvai išskaidyti į komponentus, bet
    išskaidę nebūtinai gausime komponentus, nes komponentai yra
    paketai ir todėl turi tenkinti dar Robert C. Martin nurodytus
    gerų paketų principus.}
...
lyginti. Taip pat \cites[36]{heineman2001component}{point-counterpoint}
teigimu nors komponentus realizuoti pasinaudojant objektinėmis
programavimo kalbomis ir yra patogu, bet komponentai neprivalo
būti realizuoti jomis.


Taigi teisingiau būtų lyginti \gls{component-instance}{%
...
klasių, tai vykdymo metu tik jos ir bus matomos). Tuo tarpu komponentas
yra panašus į statinio klasinio objektinio klasę tuo, kad jis yra
statinis „planas“ komponento egzemplioriaus, kaip kad klasė yra
objekto „planas“. Be to skirtumo, kad klasė yra labiau loginis, o
komponentas – fizinis darinys, iš
...
\TODO{Dar kartą peržiūrėti vadovo pastabas, nes jos kažkur pasimetė.}
