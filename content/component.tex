...
system}. Kila klausimas ar šias sistemas galime vadinti komponentinėmis,
...
tvarkymo sistema. Jos paketo savybi̇ų palyginimas su
...
\TODO{Atsakymo į klausimą, kodėl tokios panašios technologijos
visiškai skirtingai vadinamos galima būtų bandyti ieškoti
istorijoje. Paketų tvarkymo sistemos atsirado tobulinant programų
platinimo būdus (jos iš pradžių buvo platinamos paprasčiausiuose
archyvuose TODO: PAGRĮSTI), o komponentinės – nagrinėjant programų
sistemų kūrimo metodikas TODO:PAGRĮSTI. Nors pagal apibrėžimą
komponentas ir yra platinimo vienetas, bet komponentinis modelis
dažniausiai neapibrėžia kokiu būdu klientas gauna komponentą, tuo
tarpu paketų tvarkymo sistemos būtent tai ir daro. Taigi šios
sistemos palaiko skirtingas komponento gyvavimo ciklo stadijas,
o kadangi yra poreikis turėti sistemas, kurios palaiko visą gyvavimo
ciklą, tai dėl to jos ir perima viena kitos savybes.}

bluetooth riktas su PDF reader, WEB aplikacijos paleidimas, kuriai
reikia naujesnio Python.

Priklausymas tik nuo abstrakcijos turi savų problemų: nėra automatizmo,
ne taip patogu pasinaudoti kitais komponentais.


perpanaudojamumą turi, bet modifikuojamumo ir evoliucijos neturi
todėl galima būtų kelti hipotezę, kad privalomas priklausymas
nuo abstrakcijos yra esminė savybė reikalinga

pagrindinis skirtumas tarp \progname{Debian} paketo ir komponento
būtų tai, kad \progname{Debian} paketas gali nurodyti, kad yra
priklausomas nuo abstrakcijos, o komponentas turėtų būti priklausomas
nuo jos visada

Taigi skirtumas tarp paketo ir kompoento yra tai, kad negalima pakeisti.
ar šis skirtuams yra esminis reikia platesnės analizės.

Jos paketai netenkina dviejų iš
\ref{section:component:descriptions} skyrelyje išvardintų komponento
savybių: paketas savo poreikius nurodo ne per abstrakčias sąsajas,
o nurodydamas konkrečius kitus paketus, kurie yra jam reikalingi.
Virtual Package \url{http://www.debian.org/doc/manuals/debian-faq/ch-pkg_basics}
Gali prisirišti prie abstrakcijos, bet nebūtinai prisiriša.

Visgi šis klausimas reikalauja gilesnio konkrečių technologijų išmanymo,
todėl jis paliekamas atviras.

Debian gali būti, kad yra komponentinė sistema, bet kitos paketinės
– nebūtinai.
