...
Problema: sudėtingėjant sistemoms bei nuolat kintant reikalavimams
reikia priemonių leidžiančių kurti tokias sistemas evoliuciniu
būdu bei dideliam kiekiui žmonių.

Šias problemas atrodo, kad sprendžia komponentinis programavimas,
bet jis turi problemų \TODO{Martin bei Matthias Zenger
įvardintos egzistuojančių komponentinių technologijų problemos}:
\begin{itemize}
...
Vis didėjant programinės įrangos sistemoms \TODO{Pagrįsti su
statistika}, jų kūrimas darosi vis sudėtingesnis procesas
