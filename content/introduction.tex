...
Pasinaudojant Python, kaip pavyzdžiu, galima parodyti, kad
paveldėjimas ir delegavimas yra tas pats
\cite[1]{Stein:1987:DI:38807.38820}. Jei $a$ yra klasės $A$ tipo
objektas, o klasė $A$ paveldi iš $B$, tai delegavimo ryšys būtų:
$a \to A \to B$, o \varname{self} yra tiesiog paprasčiausias argumentas.
