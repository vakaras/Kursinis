...
\inputminted[linenos,bgcolor=bg]%
{scala}%
...
\NewDocumentCommand \scala {v} { \emph{#1} }
%\renewcommand{\listingscaption}{kodo fragmentas}
\renewcommand{\listoflistingscaption}{Kodo fragmentų sąrašas}
%\renewcommand{\thelisting}{\arabic{listing}}
\DeclareCaptionLabelFormat{ltcaptionlisting}{#2 kodo fragmentas}
